...
n&&n.revalidate(t)}function P(){Ct++}function k(){--Ct<=0&&(Rt.clear(),Ot.flush())}function M(e,t){P()
...
1===o?(i.writeWatching(r,0),q(t,i).remove(r)):o>1&&i.writeWatching(r,o-1)}}}function V(e){return e.match(Pt)[0]}function W(e){return"object"==typeof e&&null!==e}function K(e){return!(W(e)&&e.isDescriptor&&!1===e._volatile)}function $(){return new kt}function G(e,t,r){var n=X(e)
...
var Tt=!1,Pt=/^([^\.]+)/,kt=function(){function e(){this.chains=Object.create(null)}return e.prototype.add=function(e,t){var r=this.chains[e]
...
var ar={get onerror(){return Re},set onerror(e){return xe(e)}},sr=new u(["sync","actions","destroy"],{GUID_KEY:r.GUID_KEY,sync:{before:P,after:k},defaultQueue:"actions",onBegin:function(e){ke.currentRunLoop=e},onEnd:function(e,t){ke.currentRunLoop=t},onErrorTarget:ar,onErrorMethod:"onerror"})
ke.join=function(){return sr.join.apply(sr,arguments)},ke.bind=function(){var e,t,r
for(e=arguments.length,t=Array(e),r=0;r<e;r++)t[r]=arguments[r]
return function(){var e,r,n
for(e=arguments.length,r=Array(e),n=0;n<e;n++)r[n]=arguments[n]
return ke.join.apply(ke,t.concat(r))}},ke.backburner=sr,ke.currentRunLoop=null,ke.queues=sr.queueNames,ke.begin=function(){sr.begin()},ke.end=function(){sr.end()},ke.schedule=function(){return sr.schedule.apply(sr,arguments)},ke.hasScheduledTimers=function(){return sr.hasTimers()},ke.cancelTimers=function(){sr.cancelTimers()},ke.sync=function(){sr.currentInstance&&sr.currentInstance.queues.sync.flush()},ke.later=function(){return sr.later.apply(sr,arguments)},ke.once=function(){var e,t,r
for(e=arguments.length,t=Array(e),r=0;r<e;r++)t[r]=arguments[r]
return t.unshift("actions"),sr.scheduleOnce.apply(sr,t)},ke.scheduleOnce=function(){return sr.scheduleOnce.apply(sr,arguments)},ke.next=function(){var e,t,r
for(e=arguments.length,t=Array(e),r=0;r<e;r++)t[r]=arguments[r]
return t.push(1),sr.later.apply(sr,t)},ke.cancel=function(e){return sr.cancel(e)},ke.debounce=function(){return sr.debounce.apply(sr,arguments)},ke.throttle=function(){return sr.throttle.apply(sr,arguments)},ke._addQueue=function(e,t){-1===ke.queues.indexOf(e)&&ke.queues.splice(ke.queues.indexOf(t)+1,0,e)}
...
return r&&r.watchedEvents()||[]},e.isNone=Se,e.isEmpty=Te,e.isBlank=Pe,e.isPresent=function(e){return!Pe(e)},e.run=ke,e.ObserverSet=Et,e.beginPropertyChanges=P,e.changeProperties=M,e.endPropertyChanges=k,e.overrideChains=T,e.propertyDidChange=x,e.propertyWillChange=E,e.PROPERTY_DID_CHANGE=xt,e.defineProperty=F,e.Descriptor=D,e._hasCachedComputedProperties=function(){Tt=!0},e.watchKey=L,e.unwatchKey=z,e.ChainNode=Mt,e.finishChains=function(e){var t=e.readableChainWatchers()
...
return r}function A(e){return!(it(e,"isDestroyed")||it(e,"isDestroying"))}function S(e,t){for(var r=e.length,n=t.length,i=Math.min(r,n),o=null,a=0;a<i;a++)if(e[a]!==t[a]){o=a
...
return N(t)&&(i=e.type.inverseFor(t.key,r)),i&&(n=i.name),"hasMany"===t.kind?new ut(r,e,n,t):new lt(r,e,n,t)}function F(e){return yt(e,"attributes").has("type")||yt(e,"relationshipsByName").has("type")}function I(e){var t=void 0
...
return e.register.apply(e,arguments)}),t}function L(e){return Lt[e]||(Lt[e]=e.split("."))}function z(e){return It[e]||(It[e]=L(e)[0])}function q(e){for(var t=0;t<e.length;++t){var r=e[t]._record
...
return u=Qt.resolve(u,l),u=C(u,O(A,t)),u.then(function(i){var o=B(t,e,s),a=H(o,t,r,i,n,"findRecord")
...
return s=Qt.resolve(s,u),s=C(s,O(A,t)),s.then(function(n){var i=B(t,e,r),o=H(i,t,a,n,null,"findMany")
...
return s=Qt.resolve(s,u),s=C(s,O(A,t)),s=C(s,O(A,r)),s.then(function(r){var n=B(t,e,i.type),o=H(n,t,a,r,null,"findHasMany"),s=t._push(o)
...
return s=Qt.resolve(s,u),s=C(s,O(A,t)),s=C(s,O(A,r)),s.then(function(r){var n=B(t,e,i.type),o=H(n,t,a,r,null,"findBelongsTo")
...
return u=Qt.resolve(u,l),u=C(u,O(A,t)),u.then(function(n){var i=B(t,e,r),s=H(i,t,o,n,null,"findAll")
...
return a=Qt.resolve(a,s),a=C(a,O(A,t)),a.then(function(a){var s=B(t,e,r),u=H(s,t,o,a,null,"query"),l=t._push(u)
...
return o=Qt.resolve(o,a),o=C(o,O(A,t)),o.then(function(n){var o=B(t,e,r),a=H(o,t,i,n,null,"queryRecord")
...
e&&(o=H(u,t,a,e,n.id,r),o.included&&t._push({data:null,included:o.included}),s=o.data),t.didSaveRecord(i,{data:s})}),i},function(e){if(e instanceof We){var r=u.extractErrors(t,a,e,n.id)
...
var qe=Ember.Error,Ue=/^\/?data\/(attributes|relationships)\/(.*)/,He=/^\/?data/,Be="base",Ve=!1
a("ds-extended-errors")&&(Ve=!0),v.prototype=Object.create(qe.prototype),Ve&&(v.extend=b(v))
var We=_(v,"The adapter rejected the commit because it was invalid"),Ke=_(v,"The adapter operation timed out"),$e=_(v,"The adapter operation was aborted"),Ge=Ve?_(v,"The adapter operation is unauthorized"):null,Qe=Ve?_(v,"The adapter operation is forbidden"):null,Ye=Ve?_(v,"The adapter could not find the resource"):null,Je=Ve?_(v,"The adapter operation failed due to a conflict"):null,Xe=Ve?_(v,"The adapter operation failed due to a server error"):null,Ze=Ember.OrderedSet,et=Ember.guidFor
...
n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),ut=function(e){function t(t,r,n,i){var o=T(this,e.call(this,t,r,n,i))
...
return this._relationships.forEach(function(t,r){e=e.concat(r.members.list,r.canonicalMembers.list)}),e},e.prototype._allRelatedInternalModels=function(){var e=[],t=[],r=qt++
...
for(u&&(l=this._attributes),r=Dt(Object.create(null),this._data),r=Dt(r,this._inFlightAttributes),n=0;n<s;n++)o=a[n],i=e[o],!0===u&&void 0!==l[o]||Pt(r[o],i)||t.push(o)}return t},e.prototype.toString=function(){return"<"+this.modelName+":"+this.id+">"},e.prototype.referenceFor=function(e,t){var r=this.references[t]
...
o&&o.destroy()}},e.prototype.destroy=function(){this.isDestroying=!0,this.destroyCache(this._namespaces.adapter),this.destroyCache(this._namespaces.serializer),this.isDestroyed=!0},e.prototype.toString=function(){return"ContainerInstanceCache"},e}(),dr=Ember.A,fr=Ember._Backburner,mr=Ember.computed,yr=Ember.copy,gr=Ember.ENV,vr=Ember.Error,br=Ember.get,_r=(Ember.inspect,Ember.isNone),wr=(Ember.isPresent,Ember.MapWithDefault),Er=Ember.run,xr=Ember.set,Rr=Ember.RSVP,Or=Ember.Service,Cr=(Ember.typeOf,Rr.Promise),Ar=void 0
Ar=Or.extend({init:function(){this._super.apply(this,arguments),this._backburner=new fr(["normalizeRelationships","syncRelationships","finished"]),this.recordArrayManager=new cr({store:this}),this._identityMap=new Vt,this._pendingSave=[],this._instanceCache=new hr(I(this),this),this._modelFactoryCache=Object.create(null),this._relationshipsPayloads=new Gt(this),this._pendingSave=[],this._updatedRelationships=[],this._pushedInternalModels=[],this._updatedInternalModels=[],this._pendingFetch=wr.create({defaultValue:function(){return[]}}),this._instanceCache=new hr(I(this),this)},adapter:"-json-api",serialize:function(e,t){return a("ds-deprecate-store-serialize"),e._internalModel.createSnapshot().serialize(t)},defaultAdapter:mr("adapter",function(){var e=br(this,"adapter")
...
return Ember.String.pluralize(t)}}),jr="\r\n",Nr=de(function(e){return e&&void 0===e.nodeType?e:void 0}("object"==typeof global&&global))||de("object"==typeof self&&self)||de("object"==typeof window&&window)||new Function("return this")(),Dr=Ember.String.capitalize,Fr=Ember.String.underscore,Ir=Ember.assert,Lr=Ember.get,zr=Ember.DataAdapter.extend({getFilters:function(){return[{name:"isNew",desc:"New"},{name:"isModified",desc:"Modified"},{name:"isClean",desc:"Clean"}]},detect:function(e){return e!==ze&&ze.detect(e)},columnsForType:function(e){var t=[{name:"id",desc:"Id"}],r=0,n=this
return Lr(e,"attributes").forEach(function(e,i){if(r++>n.attributeLimit)return!1
var o=Dr(Fr(i).replace("_"," "))
t.push({name:i,desc:o})}),t},getRecords:function(e,t){if(arguments.length<2){var r=e._debugContainerKey
if(r){var n=r.match(/model:(.*)/)
n&&(t=n[1])}}return Ir("Cannot find model name. Please upgrade to Ember.js >= 1.13 for Ember Inspector support",!!t),this.get("store").peekAll(t)},getRecordColumnValues:function(e){var t=this,r=0,n={id:Lr(e,"id")}
...
e.Model=ze,e.Errors=Re,e.Store=Sr,e.DS=Tr,e.belongsTo=ce,e.hasMany=pe,e.BuildURLMixin=Mr,e.Snapshot=mt,e.AdapterError=v,e.InvalidError=We,e.UnauthorizedError=Ge,e.ForbiddenError=Qe,e.NotFoundError=Ye,e.ConflictError=Je,e.ServerError=Xe,e.TimeoutError=Ke,e.AbortError=$e,e.errorsHashToArray=w,e.errorsArrayToHash=E,e.normalizeModelName=f,e.getOwner=I,e.modelHasAttributeOrRelationshipNamedType=F,e.coerceId=J,e.parseResponseHeaders=he,e.global=Nr,e.isEnabled=a,e.RootState=Te,e.InternalModel=Ut,e.ContainerInstanceCache=hr,e.PromiseArray=ye
